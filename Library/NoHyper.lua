-- Credit To catsus
-- Add More Themes
-- Changing Square Size When Minimize
...
function NoHyper.set_theme(name:string) -- [[ YOU CAN CUSTOM THEME ]]
	...
	-- Added new themes
	elseif name:lower() == 'midnight' then
		NoHyper.Theme.BACKGROUND = Color3.fromRGB(17, 17, 27)
		NoHyper.Theme.SECTION = Color3.fromRGB(24, 24, 37)
		NoHyper.Theme.MAIN = Color3.fromRGB(126, 87, 194)
		NoHyper.Theme.STROKE = Color3.fromRGB(32, 32, 45)
		NoHyper.Theme.TOUCH = Color3.fromRGB(86, 67, 204)
		NoHyper.Theme.SYSTEM = Color3.fromRGB(147, 112, 219)
	elseif name:lower() == 'ocean' then
		NoHyper.Theme.BACKGROUND = Color3.fromRGB(16, 25, 34)
		NoHyper.Theme.SECTION = Color3.fromRGB(20, 31, 42)
		NoHyper.Theme.MAIN = Color3.fromRGB(65, 166, 186)
		NoHyper.Theme.STROKE = Color3.fromRGB(24, 37, 51)
		NoHyper.Theme.TOUCH = Color3.fromRGB(43, 110, 124)
		NoHyper.Theme.SYSTEM = Color3.fromRGB(85, 201, 225)
	elseif name:lower() == 'blood' then
		NoHyper.Theme.BACKGROUND = Color3.fromRGB(20, 5, 8)
		NoHyper.Theme.SECTION = Color3.fromRGB(30, 8, 12)
		NoHyper.Theme.MAIN = Color3.fromRGB(237, 28, 36)
		NoHyper.Theme.STROKE = Color3.fromRGB(40, 12, 16)
		NoHyper.Theme.TOUCH = Color3.fromRGB(180, 25, 30)
		NoHyper.Theme.SYSTEM = Color3.fromRGB(255, 56, 64)
	elseif name:lower() == 'sunset' then
		NoHyper.Theme.BACKGROUND = Color3.fromRGB(32, 16, 24)
		NoHyper.Theme.SECTION = Color3.fromRGB(40, 20, 30)
		NoHyper.Theme.MAIN = Color3.fromRGB(255, 128, 0)
		NoHyper.Theme.STROKE = Color3.fromRGB(48, 24, 36)
		NoHyper.Theme.TOUCH = Color3.fromRGB(204, 102, 0)
		NoHyper.Theme.SYSTEM = Color3.fromRGB(255, 153, 51)
	elseif name:lower() == 'cyberpunk' then
		NoHyper.Theme.BACKGROUND = Color3.fromRGB(13, 13, 26)
		NoHyper.Theme.SECTION = Color3.fromRGB(20, 20, 40)
		NoHyper.Theme.MAIN = Color3.fromRGB(255, 215, 0)
		NoHyper.Theme.STROKE = Color3.fromRGB(30, 30, 60)
		NoHyper.Theme.TOUCH = Color3.fromRGB(0, 255, 255)
		NoHyper.Theme.SYSTEM = Color3.fromRGB(255, 0, 128)
	end
end
...
function NoHyper.new(WindowName,WindowLogo,WindowDescription)
	...
	local function UIToggle(val)
		...
		if val then
			...
			-- Make the square smaller when closed
			Tween:Create(MainFrame,TweenInfo.new(tim),{
				Size = UDim2.new(0.05, 50, 0.05, 25), -- Smaller size when closed
